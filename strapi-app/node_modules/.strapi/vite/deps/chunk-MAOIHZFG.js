import {
  ...
  HOOKS
} from "./chunk-FHTRLNZZ.js";
import {
  useNpsSurveySettings
} from "./chunk-SGCXLLFI.js";
import {
  GuidedTourContext,
  useAIAvailability
...
import {
  useGetAIUsageQuery
} from "./chunk-L472O4YB.js";
import {
  require_pick
} from "./chunk-LR65U4GR.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-XXJPIJAC.js";
import {
  useEnterprise
} from "./chunk-N2OUV7BP.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-MRGLAG6Z.js";
import {
  Login
} from "./chunk-COIXWRTV.js";
import {
  MemoizedInputRenderer
} from "./chunk-VIM5FJGG.js";
import {
  Form
...
} from "./chunk-S67IVQWY.js";
import {
  ConfigurationProvider
} from "./chunk-A6C7PSJF.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-OEXZSR3W.js";
import {
  require_baseRest
} from "./chunk-KQQVCOSR.js";
import {
  HistoryProvider
              ...
              children: [
                ...
                (0, import_jsx_runtime6.jsx)(I, {
                  ...
                  children: formatMessage({
                    ...
                    link: (0, import_jsx_runtime6.jsx)(Wc, {
                      isExternal: true,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-ZCGOJSDC.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-EQ3UHE4A.js");
        return {
      ...
      children: [
        ...
        (0, import_jsx_runtime8.jsx)(T, {
          ...
          children: (0, import_jsx_runtime8.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime8.jsx)(Wc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
      ...
      children: [
        ...
        (0, import_jsx_runtime9.jsx)(T, {
          ...
          children: (0, import_jsx_runtime9.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime9.jsx)(Wc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
      ...
      children: [
        ...
        (0, import_jsx_runtime10.jsx)(T, {
          ...
          children: (0, import_jsx_runtime10.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime10.jsx)(Wc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
      ...
      children: [
        ...
        (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime11.jsx)(R, {
          ...
          children: (0, import_jsx_runtime11.jsx)(T, {
            justifyContent: "center",
            children: (0, import_jsx_runtime11.jsx)(Wc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
      ...
      children: [
        ...
        (0, import_jsx_runtime12.jsx)(T, {
          ...
          children: (0, import_jsx_runtime12.jsx)(R, {
            paddingTop: 4,
            children: (0, import_jsx_runtime12.jsx)(Wc, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-KVWPPY4Y.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-TZ4AE27P.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-ZLMMU2SC.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-6VJMFPXV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-EAKKJDYM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-3X33BAXV.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-5BBNI2MO.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-BYXJWTSE.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-OPLECIPS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-VH3FIGPI.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-IZZO6BLG.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-ABVVGHEM.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-4WGGPBWN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-4NCDJ4J4.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ZKWUJYSE.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-H3MKUFJX.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-EZN7JRJB.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-WNHTALH5.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-HZFQLPCS.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-HVHFE6V3.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-OO7OYDPN.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-UFCQXV4C.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-PRJ546VV.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-BER2DWQR.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-6SIVC7SD.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-VJPITSL3.js");
              return {
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-W7EPTJE5.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-BSRWB632.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-BSRWB632.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-W4YH26ST.js");
...
//# sourceMappingURL=chunk-MAOIHZFG.js.map
