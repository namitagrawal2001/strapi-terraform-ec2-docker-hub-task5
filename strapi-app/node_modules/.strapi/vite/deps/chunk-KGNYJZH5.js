import {
  require_cloneDeep
} from "./chunk-775T5HEY.js";
import {
  require_baseEach
} from "./chunk-PKV5BZW6.js";
import {
  require_isEmpty
} from "./chunk-3NS5RPAJ.js";
import {
  require_set
} from "./chunk-3TIINX3W.js";
import {
  require_merge,
  require_omit
...
var SubActionRow = ({ childrenForm = [], isFormDisabled, recursiveLevel, pathToDataFromActionRow, propertyActions, parentName, propertyName }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(R, {
    paddingLeft: `3.2rem`,
    children: [
      ...
      childrenForm.map(({ label, value, required, children: subChildrenForm }, index) => {
        ...
        return (0, import_jsx_runtime3.jsxs)(LeftBorderTimeline, {
          ...
          children: [
            ...
            displayedRecursiveChildren && isActive && (0, import_jsx_runtime3.jsx)(R, {
              paddingBottom: 2,
...
var ConditionsButtonImpl = React2.forwardRef(({ onClick, className, hasConditions = false, variant = "tertiary" }, ref) => {
  ...
  return (0, import_jsx_runtime4.jsx)(ButtonContainer, {
    ...
    children: (0, import_jsx_runtime4.jsx)(zn, {
      variant,
      startIcon: (0, import_jsx_runtime4.jsx)(u5, {}),
      onClick,
      ref,
      type: "button",
      children: formatMessage({
...
var ButtonContainer = lt(R)`
  ...
  `}
`;
var ConditionsButton = lt(ConditionsButtonImpl)``;
...
var ConditionsModal = ({ actions = [], headerBreadCrumbs = [], isFormDisabled, onClose }) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(n1.Content, {
    children: [
      (0, import_jsx_runtime5.jsx)(n1.Header, {
        children: (0, import_jsx_runtime5.jsx)(Ac, {
          id: "condition-modal-breadcrumbs",
          label: headerBreadCrumbs.join(", "),
          children: headerBreadCrumbs.map((label, index, arr) => (0, import_jsx_runtime5.jsx)(Tc, {
      ...
      (0, import_jsx_runtime5.jsxs)(n1.Body, {
        children: [
          actionsToDisplay.length === 0 && (0, import_jsx_runtime5.jsx)(I, {
            children: formatMessage({
  ...
  return (0, import_jsx_runtime5.jsxs)(T, {
    ...
    children: [
      ...
      (0, import_jsx_runtime5.jsx)(R, {
        ...
        children: (0, import_jsx_runtime5.jsx)(f1, {
          id: name,
  ...
  return (0, import_jsx_runtime6.jsxs)(BoxWrapper, {
    ...
    children: [
        ...
        children: [
          (0, import_jsx_runtime6.jsx)(RowLabelWithCheckbox, {
            ...
            children: (0, import_jsx_runtime6.jsx)(Chevron, {
              paddingLeft: 2,
              children: isActive ? (0, import_jsx_runtime6.jsx)(e5, {}) : (0, import_jsx_runtime6.jsx)(c5, {})
            })
          }),
              ...
              if (isParentCheckbox) {
                return (0, import_jsx_runtime6.jsx)(Cell, {
                  ...
                  children: (0, import_jsx_runtime6.jsxs)(R, {
                    ...
                    zIndex: 1,
                    children: [
                      hasConditions && (0, import_jsx_runtime6.jsx)(R, {
                        tag: "span",
                        position: "absolute",
                        top: "-6px",
                        left: "37px",
      ...
      (0, import_jsx_runtime6.jsx)(R, {
        ...
        right: "9px",
        position: "absolute",
        children: (0, import_jsx_runtime6.jsxs)(n1.Root, {
...
var ContentTypes = ({ isFormDisabled, kind, layout: { actions, subjects } }) => {
  ...
  return (0, import_jsx_runtime8.jsxs)(R, {
    background: "neutral0",
    children: [
...
var PluginsAndSettingsPermissions = ({ layout, ...restProps }) => {
  return (0, import_jsx_runtime9.jsx)(R, {
    padding: 6,
    background: "neutral0",
    children: (0, import_jsx_runtime9.jsx)(Sm.Root, {
      size: "M",
...
var Row = ({ childrenForm, kind, name, isFormDisabled = false, variant, pathToData }) => {
  ...
  return (0, import_jsx_runtime9.jsxs)(Sm.Item, {
    value: name,
    children: [
      (0, import_jsx_runtime9.jsx)(Sm.Header, {
        variant,
        children: (0, import_jsx_runtime9.jsx)(Sm.Trigger, {
          caretPosition: "right",
      ...
      (0, import_jsx_runtime9.jsx)(Sm.Content, {
...
var SubCategory = ({ actions = [], categoryName, isFormDisabled, subCategoryName, pathToData }) => {
  ...
  return (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, {
    children: (0, import_jsx_runtime9.jsxs)(R, {
      children: [
        (0, import_jsx_runtime9.jsxs)(T, {
          ...
          children: [
            ...
            (0, import_jsx_runtime9.jsx)(R, {
              paddingLeft: 4,
              children: (0, import_jsx_runtime9.jsx)(Tr, {
          ...
          children: [
            (0, import_jsx_runtime9.jsx)(Um.Root, {
              ...
              children: formattedActions.map(({ checkboxName, value, action, displayName, hasConditions }) => {
                return (0, import_jsx_runtime9.jsx)(Um.Item, {
                  col: 4,
                  m: 6,
                  xs: 12,
                  direction: "column",
            ...
            (0, import_jsx_runtime9.jsxs)(n1.Root, {
              open: isConditionModalOpen,
              onOpenChange: () => {
                setIsConditionModalOpen((prev) => !prev);
              },
              children: [
                (0, import_jsx_runtime9.jsx)(n1.Trigger, {
...
var Permissions = React7.forwardRef(({ layout, isFormDisabled, permissions = [] }, api) => {
  ...
  return (0, import_jsx_runtime10.jsx)(PermissionsDataManagerProvider, {
    ...
    children: (0, import_jsx_runtime10.jsxs)(S1.Root, {
      defaultValue: TAB_LABELS[0].id,
      children: [
        (0, import_jsx_runtime10.jsx)(S1.List, {
          "aria-label": formatMessage({
            id: "Settings.permissions.users.tabs.label",
            defaultMessage: "Tabs Permissions"
          }),
          children: TAB_LABELS.map((tabLabel) => (0, import_jsx_runtime10.jsx)(S1.Trigger, {
            value: tabLabel.id,
            children: formatMessage({
              id: tabLabel.labelId,
        ...
        (0, import_jsx_runtime10.jsx)(S1.Content, {
...
//# sourceMappingURL=chunk-KGNYJZH5.js.map
