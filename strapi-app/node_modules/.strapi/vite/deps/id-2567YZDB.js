...
var Stage = ({ index, canDelete = false, canReorder = false, canUpdate = false, stagesCount, name, permissions, color, defaultOpen }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(R, {
    ...
    shadow: "tableShadow",
    children: [
      liveText && (0, import_jsx_runtime2.jsx)(lt2, {
        "aria-live": "assertive",
        children: liveText
      }),
...
var AccordionRoot = lt(Sm.Root)`
  border: 1px solid
    ${({ theme, $error }) => $error ? theme.colors.danger600 : theme.colors.neutral200};
`;
var ContextMenuTrigger = lt(Am.Trigger)`
  :hover,
  :focus {
...
var NestedOption = lt(Fa)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var PermissionWrapper = lt(T)`
  > * {
    flex-grow: 1;
  }
`;
...
var NestedOption2 = lt(Fa)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var ContentTypeTakeNotice = lt(I)`
  font-style: italic;
`;
...
//# sourceMappingURL=id-2567YZDB.js.map
