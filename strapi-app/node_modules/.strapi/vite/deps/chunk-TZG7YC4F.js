import {
  require_baseMap
} from "./chunk-GGANNJK3.js";
import {
  useCreateAPITokenMutation,
  useGetAPITokenQuery,
  useUpdateAPITokenMutation
} from "./chunk-TRHSLK42.js";
import {
  ApiTokenBox,
  FormHead,
  LifeSpanInput,
      ...
      (0, import_jsx_runtime3.jsxs)(T, {
        ...
        children: [
          ...
          (0, import_jsx_runtime3.jsx)(R, {
            paddingLeft: 2,
            paddingRight: 2,
            children: (0, import_map.default)(formattedRoute, (value) => (0, import_jsx_runtime3.jsxs)(I, {
...
var ActionBoundRoutes = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(Um.Item, {
    ...
    direction: "column",
    alignItems: "stretch",
    children: selectedAction ? (0, import_jsx_runtime4.jsx)(T, {
      direction: "column",
      alignItems: "stretch",
      gap: 2,
...
var CollapsableContentType = ({ controllers = [], label, orderNumber = 0, disabled = false }) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(Sm.Item, {
    value: `${label}-${orderNumber}`,
    children: [
      (0, import_jsx_runtime5.jsx)(Sm.Header, {
        variant: orderNumber % 2 ? "primary" : "secondary",
        children: (0, import_jsx_runtime5.jsx)(Sm.Trigger, {
          children: (0, import_capitalize.default)(label)
        })
      }),
      (0, import_jsx_runtime5.jsx)(Sm.Content, {
        children: controllers == null ? void 0 : controllers.map((controller) => {
          ...
          return (0, import_jsx_runtime5.jsxs)(R, {
            children: [
                    ...
                    children: (0, import_jsx_runtime5.jsxs)(CheckboxWrapper, {
                      ...
                      children: [
                        ...
                        (0, import_jsx_runtime5.jsx)("button", {
                          ...
                          children: (0, import_jsx_runtime5.jsx)(u5, {
                            id: "cog"
                          })
                        })
                      ]
...
var ContentTypesSection = ({ section = null, ...props }) => {
  return (0, import_jsx_runtime6.jsx)(R, {
    children: (0, import_jsx_runtime6.jsx)(Sm.Root, {
      size: "M",
...
var Permissions = ({ ...props }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime7.jsxs)(Um.Root, {
    gap: 0,
    shadow: "filterShadow",
    hasRadius: true,
    background: "neutral0",
    children: [
      (0, import_jsx_runtime7.jsxs)(Um.Item, {
        xs: 12,
        col: 7,
        paddingTop: 6,
        paddingBottom: 6,
...
//# sourceMappingURL=chunk-TZG7YC4F.js.map
