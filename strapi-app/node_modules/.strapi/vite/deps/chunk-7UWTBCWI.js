...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-6IQYDJKJ.js")).CreateActionEE);
                      ...
                      children: [
                        ...
                        canRead || canDelete ? (0, import_jsx_runtime3.jsx)(Table.Cell, {
                          ...
                          children: (0, import_jsx_runtime3.jsxs)(T, {
                            justifyContent: "end",
                            children: [
                              canRead ? (0, import_jsx_runtime3.jsx)(ot, {
                                tag: NavLink,
                                to: user.id.toString(),
                                label: formatMessage({
                              ...
                              canDelete && (currentUser == null ? void 0 : currentUser.id) !== user.id ? (0, import_jsx_runtime3.jsx)(ot, {
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-G2PKJ7MP.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-7UWTBCWI.js.map
