...
var DraggableCard = ({ attribute, index, isDraggingSibling, label, name, onMoveField, onRemoveField, setIsDraggingSibling }) => {
  ...
  const composedRefs = ve(dropRef, objectRef);
...
`;
var DragButton = lt(ActionButton)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
  border-right: 1px solid ${({ theme }) => theme.colors.neutral150};
  cursor: all-scroll;
`;
var FieldContainer = lt(T)`
  max-height: 3.2rem;
  cursor: pointer;
`;
var FieldWrapper = lt(R)`
  &:last-child {
...
//# sourceMappingURL=ListConfigurationPage-Z63I4YEQ.js.map
