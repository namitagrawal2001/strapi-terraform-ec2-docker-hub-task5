import {
  useTypedSelector
} from "./chunk-JJ2TGXJW.js";
import {
  BulkActionsRenderer,
  TableActions
} from "./chunk-RPYL6KND.js";
import {
  DocumentRBAC,
  InjectionZone,
  PERMISSIONS,
...
var MediaSingle = ({ url, mime, alternativeText, name, ext, formats }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Ar, {
    label: fileName,
      ...
      (0, import_jsx_runtime4.jsxs)(Am.Content, {
        children: [
          isLoading && (0, import_jsx_runtime4.jsx)(Am.Item, {
            disabled: true,
            children: (0, import_jsx_runtime4.jsx)(Vd, {
              small: true,
...
var CellContent = ({ content, mainField, attribute, rowId, name }) => {
  ...
  switch (attribute.type) {
    ...
    case "string":
      return (0, import_jsx_runtime5.jsx)(Ar, {
        label: content,
...
//# sourceMappingURL=ListViewPage-2YVDGTR5.js.map
