          ...
          children: ({ modified, isSubmitting }) => (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
            children: [
              ...
              (0, import_jsx_runtime.jsx)(Layouts.Content, {
                children: isSubmitting || isLoadingData ? (0, import_jsx_runtime.jsx)(Page.Loading, {}) : (0, import_jsx_runtime.jsxs)(T, {
                  direction: "column",
                  alignItems: "stretch",
                  gap: 4,
                  background: "neutral0",
...
var MultiSelectInput = ({ hint, label, name, options, ...props }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Hm.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(p0, {
        onChange: (value) => field.onChange("ssoLockedRoles", value),
        onClear: () => field.onChange("ssoLockedRoles", []),
        value: field.value ?? [],
        withTags: true,
        ...props,
        children: options.map(({ label: label2, value }) => (0, import_jsx_runtime.jsx)(Fa, {
          value,
          children: label2
        }, value))
      }),
...
//# sourceMappingURL=SingleSignOnPage-EQ3UHE4A.js.map
